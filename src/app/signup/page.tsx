        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white">
          <div className="w-full max-w-md">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#057F44] focus:border-transparent outline-none transition"
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3 px-4 bg-[#057F44] text-white font-semibold rounded-lg hover:bg-[#089655] focus:ring-2 focus:ring-[#057F44] focus:ring-offset-2 transition disabled:opacity-50 flex items-center justify-center"
              >
                {loading ? (
            ...
            <p className="mt-6 text-center text-gray-600">
              ...
              <Link href="/signin" className="text-[#057F44] font-medium hover:underline">
                Sign in
              </Link>
            </p>
          </div>
